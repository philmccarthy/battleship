...
class BoardTest < Minitest::Test
  ...
  def test_board_can_check_valid_cell_placement
    assert @board.valid_cell_placement?(@submarine, "D4")
  end
  ...
  def test_valid_placement_can_be_vertical
    assert @board.valid_vertical?(@cruiser, ["B1", "C1", "D1"])
  end

  def test_valid_placements_handles_various_cases
